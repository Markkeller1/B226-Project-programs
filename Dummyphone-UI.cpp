            ...
            switch (imagechoice1)
            {
                ...
                case 1:
                    ...
                    case 1:
                        ...
                        case 1:
                            //AAU logo
                            if (!texture.loadFromFile("res/BlackBlackAAU.jpg"))
                            {
                        ...
                        case 2:
                            //B226
                            if (!texture.loadFromFile("res/BlackBlackB.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        case 3:
                            //AAU logo & B226
                            if (!texture.loadFromFile("res/BlackBlackBAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                    ...
                    case 2:
                        ...
                        case 1:
                            //AAU logo
                             if (!texture.loadFromFile("res/BlackWhiteAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        case 2:
                            //B226
                             if (!texture.loadFromFile("res/BlackWhiteB.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        case 3:
                            //AAU logo & B226
                            if (!texture.loadFromFile("res/BlackWhiteBAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                    ...
                    case 3:
                        ...
                        case 1:
                            //AAU logo
                            if (!texture.loadFromFile("res/BlackBlueAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        case 2:
                            //B226
                            if (!texture.loadFromFile("res/BlackBlueB.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        case 3:
                            //AAU logo & B226
                            if (!texture.loadFromFile("res/BlackBlueBAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                ...
                case 2:
                    //Curved top cover
                        ...
                        case 1:
                            ...
                            case 1:
                                //AAU logo
                                if (!texture.loadFromFile("res/BlackPinkAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                            ...
                            case 2:
                                //B226
                                if (!texture.loadFromFile("res/BlackPinkB.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                            ...
                            case 3:
                                //AAU logo & B226
                                if (!texture.loadFromFile("res/BlackPinkBAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                ...
                case 1:
                    ...
                    case 1:
                        ...
                        case 1:
                            //AAU logo
                            if (!texture.loadFromFile("res/WhiteBlackAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        case 2:
                            //B226
                            if (!texture.loadFromFile("res/WhiteBlackB.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        case 3:
                            //AAU logo & B226
                            if (!texture.loadFromFile("res/WhiteBlackBAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                    ...
                    case 2:
                        ...
                        case 1:
                            //AAU logo
                            if (!texture.loadFromFile("res/WhiteWhiteAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        case 2:
                            //B226
                            if (!texture.loadFromFile("res/WhiteWhiteB.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        case 3:
                            //AAU logo & B226
                            if (!texture.loadFromFile("res/WhiteWhiteBAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                    ...
                    case 3:
                        ...
                        case 1:
                            //AAU logo
                            if (!texture.loadFromFile("res/WhiteBlueAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        case 2:
                            //B226
                            if (!texture.loadFromFile("res/WhiteBlueB.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        case 3:
                            //AAU logo & B226
                            if (!texture.loadFromFile("res/WhiteBlueBAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                ...
                case 2:
                    ...
                    switch (imagechoice3)
                        ...
                        case 1:
                            ...
                            case 1:
                                //AAU logo
                            if (!texture.loadFromFile("res/WhitePinkAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                            ...
                            case 2:
                                //B226
                            if (!texture.loadFromFile("res/WhitePinkB.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                            ...
                            case 3:
                                //AAU logo & B226
                            if (!texture.loadFromFile("res/WhitePinkBAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                ...
                switch (imagechoice2)
                {
                    ...
                    switch (imagechoice3)
                    {
                        ...
                        switch (imagechoice4)
                            ...
                            case 1:
                                //AAU logo
                            if (!texture.loadFromFile("res/BlueBlackAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                            ...
                            case 2:
                                //B226
                            if (!texture.loadFromFile("res/BlueBlackB.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                            ...
                            case 3:
                                //AAU logo & B226
                            if (!texture.loadFromFile("res/BlueBlackBAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        switch (imagechoice4)
                            ...
                            case 1:
                                //AAU logo
                            if (!texture.loadFromFile("res/BlueWhiteAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                            ...
                            case 2:
                                //B226
                                if (!texture.loadFromFile("res/BlueWhiteB.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                            ...
                            case 3:
                                //AAU logo & B226
                                 if (!texture.loadFromFile("res/BlueWhiteBAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        switch (imagechoice4)
                            ...
                            case 1:
                                //AAU logo
                            if (!texture.loadFromFile("res/BlueBlueAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                            ...
                            case 2:
                                //B226
                            if (!texture.loadFromFile("res/BlueBlueB.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                            ...
                            case 3:
                                //AAU logo & B226
                            if (!texture.loadFromFile("res/BlueBlueBAAU.jpg"))
                            {
                                std::cout << "Load Failed \n";
                                system("pause");
                            }
                        ...
                        switch (imagechoice3)
                        {
                            ...
                            // Pink
                                switch (imagechoice4)
                                {
                                    case 1:
                                        //AAU logo
                                    if (!texture.loadFromFile("res/BluePinkAAU.jpg"))
                                    {
                                        std::cout << "Load Failed \n";
                                        system("pause");
                                    }
                                    ...
                                    case 2:
                                        //B226
                                    if (!texture.loadFromFile("res/BluePinkB.jpg"))
                                    {
                                        std::cout << "Load Failed \n";
                                        system("pause");
                                    }
                                    ...
                                    case 3:
                                        //AAU logo & B226
                                    if (!texture.loadFromFile("res/BluePinkBAAU.jpg"))
                                    {
                                        std::cout << "Load Failed \n";
                                        system("pause");
                                    }
